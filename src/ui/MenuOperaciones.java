...
public class MenuOperaciones {
    ...
    public void mostrar() {
        ...
        do {
            ...
            System.out.println("3. Ver acciones (Prestamos/Devoluciones)");
            System.out.println("4. Deshacer última operación");
            System.out.println("5. Atender pendientes");
            ...
            switch (opcion) {
                ...
                case 3 -> bibliotecaService.mostrarAcciones();
                case 4 -> bibliotecaService.deshacerUltimaOperacion();
                case 5 -> bibliotecaService.atenderPendientes();
